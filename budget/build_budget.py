...
DEPT_CODES = OrderedDict([
    ('水産部X',        ['0010', '0017', '0031', '0038', '0101', '0102', '0104', '0106']),  # 0038 境その他 は境港水産部
    ('鳥栖・静岡・東京', ['0042', '0045', '0046', '0047', '0550', '0551', '0552']),
    ('松江',           ['0032', '0033', '0034', '0035', '0036', '0037', '0039']),
    ('境港',           ['0903', '0904', '0909', '0910', '0911', '0914', '0915', '0916',
...
lines += [
    ('・松江と境港は担当者コードの体系（003x＝松江、09xx＝境港）で分けています。0038 境その他 は境港水産部のため水産部X に置いています。', False),
